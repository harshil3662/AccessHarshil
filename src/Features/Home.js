        ...
        <div className='row'>
          ...
          order-lg-1 order-xl-1 order-xxl-1 d-flex justify-content-center justify-content-sm-center'>
            <div className="m-5 col1">
              <div className='hv-home-col1-div1 m-5 text-center text-sm-center text-md-center text-lg-start text-xl-start'>Hello! I'm<br/><label className='my-full-name'>Harshil Vaghani.</label></div>
                      ...
                      <div className='row'>
                        <div className='col'>
                          <a href='https://github.com/harshil3662' onMouseOver={()=>{setHover1('hovered')}} onMouseOut={()=>{setHover1('')}}>
                            {hover1 ? <img className='network-img' src='github1.png' alt='github'/> : <img className='network-img' src='github.png' alt='github'/>}
                          </a>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className='row'>
                        <div className='col'>
                          <a href='https://www.linkedin.com/in/harshil-vaghani/' onMouseOver={()=>{setHover2('hovered')}} onMouseOut={()=>{setHover2('')}}>
                            {hover2 ? <img className='network-img' src='linkedin1.png' alt='linkedin'/> : <img className='network-img' src='linkedin.png' alt='linkedin'/>}
                          </a>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className='row'>
                        <div className='col'>
                          <a href='https://www.instagram.com/_harshilvaghani_/' onMouseOver={()=>{setHover3('hovered')}} onMouseOut={()=>{setHover3('')}}>
                            {hover3 ? <img className='network-img' src='instagram1.png' alt='instagram'/> : <img className='network-img' src='instagram.png' alt='instagram'/>}
                          </a>
                        </div>
                      </div>
                    </div>
